...
import { Sparkles, Loader2, Search, TrendingUp, AlertCircle } from "lucide-react";
    ...
    <div className="p-8 space-y-6">
      ...
      <Card className="border-slate-200 dark:border-slate-800 shadow-sm">
        ...
        <CardContent className="space-y-4">
          ...
          <Button onClick={generate} disabled={loading || !isConfigured} className="bg-emerald-600 hover:bg-emerald-700 text-white shadow-md shadow-emerald-600/20">
